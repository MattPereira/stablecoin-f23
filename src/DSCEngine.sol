 ...
 *
 *  Our DSC system should always be "overcollateralized". At no point, should the value of all collateral be less than or equal to the $ backed value of all the DSC.
 *
...
contract DSCEngine is ReentrancyGuard {
    ...
    uint256 private constant LIQUIDATION_THRESHOLD = 50; // 200% overcollateralized -> double the collateral compared to minted DSC
    uint256 private constant LIQUIDATION_PRECISION = 100;
    uint256 private constant MIN_HEALTH_FACTOR = 1e18;
    uint256 private constant LIQUIDATION_BONUS = 10; // 10% bonus for liquidators since number is relative to LIQUIDATION_PRECISION
    ...
    */
     ...
     * @param debtToCover debtToCover The amount of DSC you want to burn to improve the users health factor
     * 
    ...
    /*
    * @dev Low-level internal function, do nto call unless the function calling it is checking for health factors being broken
    */
    ...
    function getUsdValue(address token, uint256 amount) public view returns (uint256) {
        ...
        (, int256 price,,,) = priceFeed.staleCheckLatestRoundData();
        // 1 ETH = $1000
        // The returned value from CL wil be 1000 * 1e8
